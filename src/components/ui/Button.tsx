...
const base =
  'relative inline-flex items-center justify-center gap-2 overflow-hidden rounded-pill px-7 py-3.5 text-sm font-semibold tracking-wide cursor-pointer transition-colors duration-200'
